...
# USVT
if (dataName == "JHU") {
  dUSVTABarMean = c(4.61, 11.61, 18.18)
  dUSVTABarL = c(4.465526, 11.39987, 17.95997)
  dUSVTABarU = c(4.754474, 11.82013, 18.40003)
} else if (dataName == "desikan") {
  dUSVTABarMean = c(6.36, 12.68, 19.55)
  dUSVTABarL = c(6.198711, 12.47551, 19.35032)
  dUSVTABarU = c(6.521289, 12.88449, 19.74968)
} else if (dataName == "CPAC200") {
  dUSVTABarMean = c(10.08, 18.86, 27.77)
  dUSVTABarL = c(9.732408, 18.51539, 27.44055)
  dUSVTABarU = c(10.427592, 19.20461, 28.09945)
}
...
for (iM in 1:length(mVec)) {
  ...
  # Eigen-decomposition
  fileName <- paste("../../Result/result_", dataName, "_brute_", "m_", m, "_q_", q, "_eig_single_aug.RData", sep="")
  load(fileName)
