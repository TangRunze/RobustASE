...
for (m in mVec) {
  ...
  if (isSVD) {
    fileName = paste("../../Result/result_", dataName, "_brute_", "m_", m, "_q_", q, "_svd_single_aug_20.RData", sep="")
  } else {
    fileName = paste("../../Result/result_", dataName, "_brute_", "m_", m, "_q_", q, "_eig_single_aug_20.RData", sep="")
  }
